...
**Created**: 2025-08-22\
**Updated**: 2025-09-29 (最新状況: #168 進行中 - Docker開発環境改善実装)\
...
- #161 - スクレイピング更新時のnotification_scheduledフィールド上書き問題を修正 ✅ **NEW**
...
| ----- | ------------------------------------------------------------- | ------------------ | -------- | ----------- |
| #168  | 開発環境でのwatch機能とプロダクション環境でのテストモード機能 | 開発効率・機能拡張 | 🔴 High  | ⏳ **IN PROGRESS** |
| #72   | データベースへのクエリ回数を最適化する                        | パフォーマンス改善 | 🔴 High  | 🚨 **OPEN** |
...
1. **#168** - 開発環境でのwatch機能とプロダクション環境でのテストモード機能の両立実装 ⏳ **IN PROGRESS**
   - **内容**: 開発環境での効率的なwatch機能とプロダクション環境でのテストモード実装
   - **進捗**: Docker環境改善・新タスクコマンド追加・サービス名統一実装中
   - **期待効果**: 開発フロー改善・プロダクション品質向上
