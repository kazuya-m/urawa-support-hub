...
**Created**: 2025-08-22\
**Updated**: 2025-11-07 (最新状況: #184 collect-ticketエラー発生により緊急対応中)\
...
### ✅ **最近完了・クローズしたイシュー (2025-11-07)**:

- #184 - collect-ticketがエラー ✅ **NEW - HOTFIX完了**
...
## Next Steps Priority (**UPDATED: 2025-11-07**)

### 🎯 **推奨実装順序**

#### 📍 **高優先タスク** (機能改善・開発効率)

1. **#182** - Ticket Entityのupsert改善：既存値保持と差分更新ロジックの実装 🟠 **HIGH PRIORITY**
...
3. **#181** - SaleStatusServiceのリファクタリング：サイト固有フォーマットを分離 🟡
