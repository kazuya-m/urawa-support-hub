...
**Created**: 2025-08-22\
**Updated**: 2025-09-27 (Issue #149 完了, Issue #50 クローズ)\
...
| Issue | Title                                                | Category         | Status |
| ----- | ---------------------------------------------------- | ---------------- | ------ |
| #150  | インフラ層のスクレイピング関連ディレクトリ構造を統合 | リファクタリング | Open   |
| #67   | ヴィッセル神戸対応                                   | 他チーム対応     | Open   |
| #66   | サンフレッチェ広島対応                               | 他チーム対応     | Open   |
| #105  | 2026年シーズン制度変更対応                           | 長期計画         | Open   |

## Next Steps Priority (**UPDATED: 2025-09-27**)

### 🎯 **推奨実装順序**

#### 📍 **現在実装可能なタスク** (最適化・リファクタリング)

1. **#150** - インフラ層のスクレイピング関連ディレクトリ構造を統合 🟡
   - **理由**: コード整理・保守性向上
   - **影響**: スクレイピング関連コードの見通し改善
