...
import { JLeagueRawTicketData } from '@/infrastructure/services/scraping/sources/jleague/types/JLeagueTypes.ts';
import { JLeagueDataParser } from '@/infrastructure/services/scraping/sources/jleague/parser/JLeagueDataParser.ts';
